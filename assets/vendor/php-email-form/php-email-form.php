...
class PHP_Email_Form {
  ...
  public $error_msg = array(
    ...
    'invalid_source' => 'Source is empty!',
  ...
  public function add_message($content, $label = '', $value_check = false) {
    $message = filter_var($content, FILTER_SANITIZE_STRING) . '<br>';
    if( $value_check ) {
      if( $message == "") {
        $this->error .=  $label . ' ' . $this->error_msg['empty'] . '<br>';
        return;
      }
    }
  ...
  public function send() {
    ...
    $source = filter_var ( $this->source, FILTER_SANITIZE_STRING);
    ...
    if( ! $source )
      $this->error .= $this->error_msg['invalid_source'] . '<br>';
